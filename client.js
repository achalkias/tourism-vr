...
class surfaceModule extends Module {
  ...
  start() {
    ...
    r360.renderToSurface(
      r360.createRoot('InfoPanel',{id: 'shopping', text: 'Shop until you drop!'}),
      shoppingPanel
    );
  
    r360.renderToSurface(
      r360.createRoot('InfoPanel',{id: 'museum', text: 'The Life of Pablo Picasso: Blue'}),
      museumPanel
    );
  
    r360.renderToSurface(
      r360.createRoot('InfoPanel',{id: 'restaurant', text: 'Enjoy a delicious beer at our restaurants.'}),
      restaurantPanel
    );
